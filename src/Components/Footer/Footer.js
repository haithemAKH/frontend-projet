    ...
    <footer>
      <div className="Info">
        <div>
          ...
          <p className="text">
            <h4>Livraison sur le grand tunis <TbTruckDelivery/></h4>
          </p>
        </div>
        <div>
          <img src={img2} className="Image1" alt="Service client" />{" "}
          <p className="text">
            <h4>Service client <FaPhoneAlt/></h4>
          </p>
        </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col">
              ...
              <a href="tel:+216-98001001" className="path">
                <img src={phone} className="ico" alt="img" />
                Tél : (+216) 98 001 001
              </a>
              <a href="mailto: haythem@gmail.com" className="path">
                <p>
          ...
          <div className="row">
            <p className="col-sm">
              &copy;{new Date().getFullYear()} PHOENIX | All rights reserved |
